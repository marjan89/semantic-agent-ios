        ...
        DispatchQueue.main.async {
            if scrollSteps > 0 {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 30) {
                    ...
                    responded = true
                    self.send(conn, status: "408 Request Timeout", type: "application/json",
                              body: "{\"error\":\"walkWithScroll timed out after 30s\"}")
                }
